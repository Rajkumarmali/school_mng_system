...
import { downloadStudentAdmitCard, downloadStudentApplicationForm, getStudentUniversityExamsByUserId } from '../../../state/universityExam/Action';
...
const StudentUniversityExam = () => {
    ...
    const handleShowTimeTable = async (universityExamId) => {
        setSearchParams({ page: pageNumber, size: pageSize, universityExamId: universityExamId, action: 'showTimeTable' })
    }

    const handleResult = (studentUniversityExamId) => {
        setSearchParams({ page: pageNumber, size: pageSize, studentUniversityExamId, action: 'result' })
    }

    const handleShowAdmitCard = async (examId) => {
        const pdfBlob = await dispactch(downloadStudentAdmitCard(examId));
        const url = window.URL.createObjectURL(pdfBlob);
        window.open(url, "_blank")
    }
    ...
    return (
        <div className="student-universityexam-container">
            {
                (action === 'showTimeTable' && universityExamId) ?
                    <div>
                        <TimeTable />
                    </div>
                    :
                    (action === "result" && studentUniversityExamId) ?
                        <div>
                            <Result />
                        </div>
                        :
                                            ...
                                            >
                                                ...
                                                <div className="student-exam-card-footer">
                                                    ...
                                                    <div className="student-exam-actions">
                                                        {
                                                            exam?.universityExamResponse?.showResult &&
                                                            <button className="register-exam-btn"
                                                                onClick={() => handleResult(exam.id)}
                                                            >
                                                        ...
                                                        {
                                                            exam.universityExamResponse.showAdmitCard &&
                                                            <button className="register-exam-btn"
                                                                onClick={() => handleShowAdmitCard(exam.id)}
                                                            >
                                                        ...
                                                        {
                                                            exam.universityExamResponse?.showTimeTable &&
                                                            <button className="register-exam-btn"
                                                                onClick={() => handleShowTimeTable(exam.universityExamResponse.id)}
                                                            >
