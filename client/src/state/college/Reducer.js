...
export const collegeReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case ASSIGN_COURSE_TO_COLLEGE_REQUEST:
        case GET_COLLEGES_COURSE_REQUEST:
        ...
        case GET_COLLEGES_COURSE_SUCCESS:
            return {
                ...state,
                isLoading: false,
                error: null,
        ...
        case ASSIGN_COURSE_TO_COLLEGE_FAILER:
        case GET_COLLEGES_COURSE_FAILER:
        ...
        case ASSIGN_COURSE_TO_COLLEGE_SUCCESS:
