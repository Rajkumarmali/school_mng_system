import {
    ...
    DELETE_STUDENT_SUCCESS, GET_ALLSTUDENT_FAILER, GET_ALLSTUDENT_REQUEST, GET_ALLSTUDENT_SUCCESS, GET_STUDENT_ATTENDANCE_FAILER, GET_STUDENT_ATTENDANCE_REQUEST, GET_STUDENT_ATTENDANCE_SUCCESS, GET_STUDENT_BYID_FAILER,
    GET_STUDENT_BYID_REQUEST, GET_STUDENT_BYID_SUCCESS, GET_STUDENT_DOCUMENT_FAILER, GET_STUDENT_DOCUMENT_REQUEST, GET_STUDENT_DOCUMENT_SUCCESS, GET_STUDENT_DOCUMENTBYID_FAILER, GET_STUDENT_DOCUMENTBYID_REQUEST, GET_STUDENT_DOCUMENTBYID_SUCCESS, GET_STUDENT_SUBJECTS_FAILER, GET_STUDENT_SUBJECTS_REQUEST, GET_STUDENT_SUBJECTS_SUCCESS, GET_STUDENTS_FEEOVERVIEW_FAILER, GET_STUDENTS_FEEOVERVIEW_REQUEST, GET_STUDENTS_FEEOVERVIEW_SUCCESS, GET_STUDENTS_PAIDFEE_FAILER, GET_STUDENTS_PAIDFEE_REQUEST, GET_STUDENTS_PAIDFEE_SUCCESS,
...
export const studentReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case GET_STUDENT_SUBJECTS_REQUEST:
        case GET_STUDENT_ATTENDANCE_REQUEST:
            return {
                ...state,
                isLoading: true,
                error: null
        ...
        case GET_STUDENT_SUBJECTS_FAILER:
        case GET_STUDENT_ATTENDANCE_FAILER:
            return {
                ...state,
                isLoading: false,
